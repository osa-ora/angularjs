...
angular.module('customers', ['ngTable','ngResource']);
...
myApp.factory('customerServices', ['$http', function($http) {
    ...
    var factoryDefinitions = {
	  getCustomers: function() {
        return $http.get('http://localhost:8080/demoRestAPI/rest/Customers')
                 .then(
	  ...
	  getCustomer: function(customerId) {
        return $http.get('http://localhost:8080/demoRestAPI/rest/Customers?id=' + customerId).success(function(data) { return data; });
      },
...
myApp.factory('customerServicess', ['$resource', function($resource) {
  return $resource('http://localhost:8080/demoRestAPI/rest/Customers/:id', 
          {},
          {
...
//Controllers
//myApp.controller('getCustomersController', ['$scope', 'customerServicess', 'dataTable', function($scope, customerServicess, dataTable) {
//        customerServicess.query(function(result){
//            $scope.data = result;
//               dataTable.render($scope, '', "customerstList", result.response);
//        }, function(httpResponse){
//           console.log('cumi... ' + httpResponse.status + ": " + httpResponse.statusText);
//        });
//}]);
